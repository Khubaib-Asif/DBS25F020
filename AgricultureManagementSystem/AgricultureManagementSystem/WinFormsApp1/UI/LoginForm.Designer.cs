namespace AgricultureManagementSystem
{
    partial class LoginForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            link.FlatAppearance.BorderColor = Color.White;
            link.FlatAppearance.MouseDownBackColor = Color.White;
            link.FlatAppearance.MouseOverBackColor = Color.White;
            link.FlatStyle = FlatStyle.Flat;
            link.Font = new Font("Segoe UI Semibold", 9.75F, FontStyle.Bold);
            link.ForeColor = SystemColors.Highlight;
            link.Location = new Point(159, 763);
            link.Margin = new Padding(4, 5, 4, 5);
            link.Name = "link";
            link.Size = new Size(367, 67);
            link.TabIndex = 8;
            link.Text = "Don't have an account? Register here.";
            link.UseVisualStyleBackColor = false;
            link.Click += btnRegister_Click;
            // 
            // btnForgot
            // 
